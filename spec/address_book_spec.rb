...
def check_entry(entry, expected_name, expected_number, expected_email)
  ...
  describe "#remove entry" do 
    it "remove an entry using the name, phone_number, and email_address" do
     	book.add_entry('Chase Massey', '478.251.0820', 'chasemassey@gmail.com')
       ...
       book.add_entry(name, phone_number, email_address)
	     ...
	     expect(book.entries.size).to eq 1
	     expect(book.entries.first.name).to eq("Chase Massey")
    end
  end 
